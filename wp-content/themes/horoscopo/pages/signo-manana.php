...
$ccc = strtotime(current_time('timestamp')." +1 day");
//echo $ctime;
//$mmm = 
...
//$m = current_time('n');
	...
	echo '<div class="before-signo-content hoy">';
		echo '<div class="wrap">';
			...
			echo "<h2>Horóscopo ".get_the_title()."</h2><img class='img-t' src='".$image_url."'> <p> (".$dw.", ".date('d',strtotime("+1 day"))." de ".$t." de ".date('Y',strtotime("+1 day")).")";
			echo "<p>(".$fecha.")</p>";
			echo '<div class="row">';
